...
\section{Sentences are the true building blocks of literature.}
...
\section{Tools that provide optimal text-editing are critical for managing such sentences.}
...
\subsection{Latex ensures manipulation of each sentence's raw text content, yet provides elgantly styled output.}
...
\subsection{Git can keep track of all text changes throughout time.} 
\subsubsection{Authentication Method Ranking}
